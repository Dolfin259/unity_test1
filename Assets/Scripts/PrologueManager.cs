...
public class PrologueManager : MonoBehaviour
{
   ...
   [SerializeField]
    ...
    "「彼は王国に仕える元騎士だった」&「だが、汚れきった王政に仕える意義を無くし、今はあてもなく便利屋として剣を振るっていた。」&「仕官した当時の志はもはや無くなり、磨かれた剣技は日銭を稼ぐための道具となっていた」&「あてもなく歩いていると、気づけば怪しげな森の中にいた」&「引き返そうにも、なぜか今まで歩いてきた道がない,,,」&「男は仕方なく先へ進むのであったーー」";
