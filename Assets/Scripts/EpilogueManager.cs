...
public class EpilogueManager : MonoBehaviour
{
   ...
   [SerializeField]
    ...
    "「ーー森の奥の墓場を抜けると自分と瓜二つの”なにか”に襲われた」&「あれは幻だったのだろうか,,,」&「辺りを見渡すと森は消え、 もといた場所に立っていた」&「彼は自分自身に打ち勝ったのだ」&「誰に話しても信じてもらえるはずもない」&「とんだ目にあったと嘆いたが、男の目はかつての輝きを少しだけ取り戻していた」&「自分には まだ出来ることがあるかもしれない,,,」&「ーー孤独な騎士は歩き始めた」&「GAMECLEAR」";
